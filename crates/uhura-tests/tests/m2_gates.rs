...
const REJECTIONS: &[Rejection] = &[
    Rejection {
        ...
        from: "<img class=\"avatar\" src={post.author.avatar.src} alt={post.author.avatar.alt} />",
        to: "<avatar class=\"avatar\" src={post.author.avatar.src} alt={post.author.avatar.alt} />",
        expect_code: "UH5001",
        expect_severity: Severity::Error,
    },
    Rejection {
        name: "legacy-image-element",
        file: "components/post-card.uhura",
        from: "<img class=\"avatar\" src={post.author.avatar.src} alt={post.author.avatar.alt} />",
        to: "<image class=\"avatar\" src={post.author.avatar.src} alt={post.author.avatar.alt} />",
        expect_code: "UH5001",
        expect_severity: Severity::Error,
    },
    Rejection {
        name: "legacy-text-field-element",
        file: "app/search/page.uhura",
        from: "<textfield value={query} label=\"Search accounts and posts\" placeholder=\"Search accounts and posts…\" disabled={search-pending} on:change={emit query-changed()} on:submit={emit search-submitted()} />",
        to: "<text-field value={query} label=\"Search accounts and posts\" placeholder=\"Search accounts and posts…\" disabled={search-pending} on:change={emit query-changed()} on:submit={emit search-submitted()} />",
        expect_code: "UH5001",
        expect_severity: Severity::Error,
    },
    Rejection {
    ...
    Rejection {
        ...
        file: "components/post-card.uhura",
        from: "<img class=\"media\" src={m.image.src} alt={m.image.alt} />",
        to: "<img class=\"media\" src={m.image.src} alt={m.image.alt} decorative />",
        expect_code: "UH5009",
        expect_severity: Severity::Error,
    },
    Rejection {
        name: "image-text-alternative-required",
        file: "components/post-card.uhura",
        from: "<img class=\"media\" src={m.image.src} alt={m.image.alt} />",
        to: "<img class=\"media\" src={m.image.src} />",
        expect_code: "UH5009",
        expect_severity: Severity::Error,
    },
    Rejection {
        name: "decorative-is-a-marker",
        file: "components/post-card.uhura",
        from: "<img class=\"media\" src={m.image.src} alt={m.image.alt} />",
        to: "<img class=\"media\" src={m.image.src} decorative={false} />",
        expect_code: "UH5009",
        expect_severity: Severity::Error,
    },
    Rejection {
