//! Authored ownership and dependency topology for checked Uhura source.
//!
...
pub(super) struct TopologyBinding {
    pub source_package: String,
...
pub(super) fn build_local(
    ...
    let bindings = bindings
        .iter()
        .map(
            |((source_module, local_name), (target_module, target_name))| TopologyBinding {
...
impl<'a> Builder<'a> {
    fn new(modules: &'a [ast::Module], bindings: &[TopologyBinding]) -> Self {
