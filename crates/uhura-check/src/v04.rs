...
pub fn check_module(module: &v04::ast::Module) -> CheckOutput {
...
pub fn resolve_project_modules(modules: &[v04::ast::Module]) -> ResolvedProject {
...
pub fn check_project_modules(modules: &[v04::ast::Module]) -> CheckOutput {
...
pub fn check_resolved_project_with_evidence(
    ...
    let composition = crate::v04_parts::compose_project(
        &project.modules,
        &bindings,
    ...
    crate::v04_updates::lower_project(&mut modules, &mut composition_diagnostics);
    ...
    if has_errors(&output.diagnostics) {
        ...
        match crate::v04_provenance::build_v04_provenance(&project.modules) {
            Ok(provenance) => output.provenance = Some(provenance),
            Err(failure) => {
...
pub fn check_package_graph_with_evidence(
    ...
    let mut part_catalog = crate::v04_parts::PartCatalog::default();
    ...
    for (package, resolution, bindings) in resolved_packages {
        let mut composition_diagnostics = Vec::new();
        let composition = crate::v04_parts::compose_package(
            &package.package,
            &package.modules,
            &bindings,
            &part_catalog,
...
fn link_composed_package_source(
    ...
    // identity.
    let synthetic = v04::ast::Span::new(0, 0, 0);
...
fn build_package_graph_provenance(
    packages: &[CapturedPackageModules],
    external_references: &BTreeMap<String, Vec<crate::v04_provenance::V04ExternalReference>>,
    topology_bindings: &[crate::v04_topology::V04TopologyBinding],
    site_compositions: &[crate::v04_parts::CompositionOutput],
    ...
    for package in ordered {
        ...
        for module in &mut modules {
            module.uses.retain(|declaration| {
                ...
                matches!(root, v04::ast::ImportRoot::Crate(_))
                    || matches!(root, v04::ast::ImportRoot::Package(name) if name.text == "uhura")
            });
        }
        let references = external_references
            ...
            .map(Vec::as_slice)
            .unwrap_or_default();
        let provenance = crate::v04_provenance::build_v04_provenance_with_external_references(
            &modules, references,
        )
    ...
    for origin in site_compositions
        .iter()
        .flat_map(crate::v04_parts::CompositionOutput::site_occurrences)
    {
    ...
    let topology = crate::v04_topology::build_linked(&original_modules, topology_bindings)?;
    ...
    Provenance::canonical_with_topology(sources, occurrences, topology.topology)
}
...
fn build_external_catalog(
        ...
        for module in &package.modules {
            for declaration in &module.declarations {
                ...
                let record = match &declaration.kind {
                    v04::ast::DeclarationKind::Struct(value) => Some(RecordShape {
                        fields: value
                            .fields
                            .iter()
                ...
                let variants = match &declaration.kind {
                    v04::ast::DeclarationKind::Enum(value) => value
                        .variants
                        .iter()
                        .map(|variant| {
                            (
        ...
        for module in &package.modules {
            for declaration in &module.uses {
                ...
                let target_package = match &path.root {
                    v04::ast::ImportRoot::Crate(_) => package.package.clone(),
                    v04::ast::ImportRoot::Package(alias) if alias.text == "uhura" => continue,
                    v04::ast::ImportRoot::Package(alias) => {
    ...
    loop {
        ...
        for request in pending {
            ...
            if target.visibility != v04::ast::Visibility::Public {
                continue;
            }
            ...
            catalog.insert(
                route,
                ExternalDeclaration {
                    visibility: v04::ast::Visibility::Public,
...
struct Resolution {
    ...
    external_references: Vec<crate::v04_provenance::V04ExternalReference>,
    topology_bindings: Vec<crate::v04_topology::V04TopologyBinding>,
...
impl Resolution {
    fn build(
        ...
        for source in &ordered {
            ...
            for declaration in &source.declarations {
                ...
                resolution.metadata.declarations.push(ResolvedDeclaration {
                    ...
                    module: source.identity.module.clone(),
                    name: name.text.clone(),
                    public_id: (visibility == v04::ast::Visibility::Public)
                ...
                let lowering_name = if visibility == v04::ast::Visibility::Private {
        ...
        for source in &ordered {
            for declaration in &source.uses {
                ...
                match import_requests(source, declaration, &mut resolution.diagnostics) {
                    Some(requests) if declaration.visibility == v04::ast::Visibility::Public => {
        ...
        loop {
            ...
            for request in pending {
                ...
                resolution
                    .topology_bindings
                    .push(crate::v04_topology::V04TopologyBinding {
    ...
    fn handle_external_use(
        ...
        let v04::ast::ImportRoot::Package(alias) = root else {
            return false;
        };
        if alias.text == "uhura" {
            return false;
        ...
        let requests = match &declaration.tree {
            v04::ast::ImportTree::Single { path, alias } => {
            ...
            v04::ast::ImportTree::Group { prefix, items } => {
        ...
        for (target_module, target_name, local_name, binding_span, target_span) in requests {
            ...
            self.external_references
                .push(crate::v04_provenance::V04ExternalReference {
            ...
            self.metadata.bindings.push(ResolvedBinding {
                ...
                target_module,
                target_name,
                reexport: declaration.visibility == v04::ast::Visibility::Public,
                span: binding_span,
                target_span,
            });
        }
    ...
    fn unresolved_import(
        ...
        if declarations
            .get(&target_key)
            .is_some_and(|value| value.visibility == v04::ast::Visibility::Private)
        {
            self.diagnostics.push(error(
                codes::IMPORT,
...
fn standard_import_requests(
    ...
    let v04::ast::ImportRoot::Package(root) = root else {
        return None;
    };
    if root.text != "uhura" {
        return None;
...
fn import_requests(
    ...
    if declaration.visibility == v04::ast::Visibility::Public
        && !matches!(
            &declaration.tree,
            v04::ast::ImportTree::Single { alias: None, .. }
        )
    {
        diagnostics.push(error(
            codes::IMPORT,
    ...
    match &declaration.tree {
        ...
        v04::ast::ImportTree::Group { prefix, items } => {
            let module = match &prefix.root {
                v04::ast::ImportRoot::Crate(_) if !prefix.segments.is_empty() => prefix
                    .segments
                    .iter()
                    .map(|value| value.text.as_str())
                    .collect::<Vec<_>>()
                    .join("::"),
                v04::ast::ImportRoot::Crate(_) => {
                    diagnostics.push(error(
                        codes::IMPORT,
                ...
                v04::ast::ImportRoot::Package(root) => {
...
fn current_package_locator<'a>(
    root: &v04::ast::ImportRoot,
    segments: &'a [v04::ast::Identifier],
    locator_span: v04::ast::Span,
    diagnostics: &mut Vec<uhura_base::Diagnostic>,
) -> Option<(String, &'a v04::ast::Identifier)> {
    if let v04::ast::ImportRoot::Package(root) = root {
...
fn declaration_header(
...
) -> (&v04::ast::Identifier, v04::ast::Visibility) {
    match &declaration.kind {
        ...
        v04::ast::DeclarationKind::Const(value) => (&value.name, value.visibility),
        v04::ast::DeclarationKind::Function(value) => (&value.name, value.visibility),
    }
}
...
fn private_declaration_ownership(
    ...
    let mut declarations = BTreeMap::<DeclarationKey, &v04::ast::Declaration>::new();
...
fn private_reference_target(
    module: &str,
    reference: &str,
    declarations: &BTreeMap<DeclarationKey, &v04::ast::Declaration>,
    ...
    declarations.get(&key).and_then(|declaration| {
        ...
        (visibility == v04::ast::Visibility::Private).then_some(key)
    })
}

fn private_declaration_requires_owner(declaration: &v04::ast::Declaration) -> bool {
    matches!(
        declaration.kind,
        v04::ast::DeclarationKind::Machine(_)
...
fn private_declaration_kind(declaration: &v04::ast::Declaration) -> &'static str {
    match declaration.kind {
        v04::ast::DeclarationKind::Machine(_) => "machine",
        v04::ast::DeclarationKind::Part(_) => "Part",
        v04::ast::DeclarationKind::Ui(_) => "UI declaration",
        v04::ast::DeclarationKind::Struct(_) => "struct",
        v04::ast::DeclarationKind::Enum(_) => "enum",
        v04::ast::DeclarationKind::Key(_) => "key",
        v04::ast::DeclarationKind::Const(_) => "const",
...
fn source_name_expression(name: String, span: v04::ast::Span) -> v04::ast::Expression {
    v04::ast::Node::new(
...
fn machine_non_port_value_names(machine: &v04::ast::MachineDeclaration) -> BTreeSet<String> {
    machine
        .members
        .iter()
        .flat_map(|member| match &member.kind {
            v04::ast::MachineMemberKind::Config(value) => value
                .fields
                .iter()
                .map(|field| field.name.text.clone())
                .collect::<Vec<_>>(),
            v04::ast::MachineMemberKind::Const(value) => vec![value.name.text.clone()],
            v04::ast::MachineMemberKind::Function(value) => vec![value.name.text.clone()],
            v04::ast::MachineMemberKind::State(value) => value
                .fields
                .iter()
                .map(|field| field.name.text.clone())
                .collect(),
            v04::ast::MachineMemberKind::Computed(value) => vec![value.name.text.clone()],
            v04::ast::MachineMemberKind::Update(value) => vec![value.name.text.clone()],
            _ => Vec::new(),
        })
        .collect()
}
...
struct Adapter<'a> {
    source: &'a v04::ast::Module,
    diagnostics: Vec<uhura_base::Diagnostic>,
    bindings: BTreeMap<String, String>,
    structs: BTreeMap<String, RecordShape>,
    variants: BTreeMap<(String, String), RecordShape>,
    private_functions: BTreeMap<String, v04::ast::FunctionDeclaration>,
    inlining: Vec<String>,
...
impl<'a> Adapter<'a> {
    ...
    fn declaration(&mut self, declaration: &v04::ast::Declaration) -> Option<ast::Declaration> {
        ...
        let mut value = match &declaration.kind {
            ...
            v04::ast::DeclarationKind::Key(value) => ast::DeclarationKind::Key(ast::KeyDecl {
            ...
            v04::ast::DeclarationKind::Part(_) => {
                self.unsupported(
                    declaration.span,
    ...
    fn enum_declaration(&mut self, value: &v04::ast::EnumDeclaration) -> ast::TypeDecl {
        let span = self.span(value.name.span);
        ast::TypeDecl {
            name: self.name(&value.name),
            parameters: Vec::new(),
    ...
    fn const_declaration(&mut self, value: &v04::ast::ConstDeclaration) -> ast::ConstDecl {
        ast::ConstDecl {
            name: self.name(&value.name),
            ty: self.ty(&value.ty),
    ...
    fn function_declaration(&mut self, value: &v04::ast::FunctionDeclaration) -> ast::FunctionDecl {
        ast::FunctionDecl {
            name: self.name(&value.name),
            parameters: value
                .parameters
    ...
    fn machine_declaration(&mut self, value: &v04::ast::MachineDeclaration) -> ast::MachineDecl {
        ...
        let mut ports = value
            ...
            .filter_map(|member| match &member.kind {
                v04::ast::MachineMemberKind::Port(port) => Some((port, member.span)),
                _ => None,
            })
            .collect::<Vec<_>>();
        ...
        for member in &value.members {
            ...
            let lowered = match &member.kind {
                v04::ast::MachineMemberKind::Config(section) => {
                ...
                v04::ast::MachineMemberKind::Const(declaration) => {
                    ast::MachineMemberKind::Const(self.const_declaration(declaration))
                }
                v04::ast::MachineMemberKind::Function(declaration) => {
                ...
                v04::ast::MachineMemberKind::Computed(declaration) => {
                ...
                v04::ast::MachineMemberKind::Invariant(declaration) => {
                ...
                v04::ast::MachineMemberKind::Observe(section) => {
                    has_observe = true;
                ...
                v04::ast::MachineMemberKind::Handler(declaration) => {
                    requires_outcome = true;
                    ast::MachineMemberKind::Handler(self.handler_declaration(declaration))
                }
                v04::ast::MachineMemberKind::Update(declaration) => {
                    requires_outcome = true;
                ...
                v04::ast::MachineMemberKind::BeforeCommit(declaration) => {
                    requires_outcome = true;
    ...
    fn protocol_domain(&mut self, value: &v04::ast::ProtocolSection) -> ast::SumDomain {
    ...
    fn protocol_variant(&mut self, value: &v04::ast::ProtocolVariant) -> ast::Variant {
        ast::Variant {
            name: self.name(&value.name),
    ...
    fn port_declaration(&mut self, value: &v04::ast::PortDeclaration) -> ast::PortDecl {
        ...
        let contract = v04::ast::Node::new(
            v04::ast::TypeExpressionKind::Path(value.contract.clone()),
            value.contract.span,
        );
        ast::PortDecl {
            name: self.name(&value.name),
    ...
    fn outcome_declaration(&mut self, value: &v04::ast::OutcomeSection) -> ast::OutcomeDecl {
        ast::OutcomeDecl {
            variants: value
                .entries
                .iter()
                .map(|entry| ast::OutcomeVariant {
                    ...
                    policy: ast::Spanned::new(
                        match entry.policy {
                            v04::ast::OutcomePolicy::Commit => ast::OutcomePolicy::Commit,
                            v04::ast::OutcomePolicy::Abort => ast::OutcomePolicy::Abort,
                        },
    ...
    fn protocol_selector_name(&self, value: &v04::ast::ProtocolSelector) -> String {
    ...
    fn handler_declaration(&mut self, value: &v04::ast::HandlerDeclaration) -> ast::HandlerDecl {
    ...
    fn pure_block_expression(&mut self, block: &v04::ast::Block, env: &ExprEnv) -> ast::Expr {
    ...
    fn plain_pure_block_expression(&mut self, block: &v04::ast::Block, env: &ExprEnv) -> ast::Expr {
    ...
    fn pure_flow_block_at(
        ...
        match &statement.kind {
            ...
            | v04::ast::StatementKind::BlockExpression(expression) => self.pure_flow_expression(
                expression,
                env,
    ...
    fn pure_flow_expression(
        ...
        match &expression.kind {
            ...
            v04::ast::ExpressionKind::If(value) => self.pure_flow_expression(
                &value.condition,
                env,
            ...
            v04::ast::ExpressionKind::Match(value) => self.pure_flow_expression(
                &value.value,
                env,
            ...
            v04::ast::ExpressionKind::Unary { operator, value } => self.pure_flow_expression(
                value,
                env,
            ...
            v04::ast::ExpressionKind::Member { value, member } => self.pure_flow_expression(
                value,
                env,
            ...
            v04::ast::ExpressionKind::Index { value, index } => self.pure_flow_expression(
                value,
                env,
            ...
            v04::ast::ExpressionKind::Is { value, pattern } => self.pure_flow_expression(
                value,
                env,
                PureContinuation::Is {
            ...
            | v04::ast::ExpressionKind::Tuple(values) => {
                let tuple = matches!(expression.kind, v04::ast::ExpressionKind::Tuple(_));
            ...
            v04::ast::ExpressionKind::Call { callee, arguments } => {
                if arguments.iter().any(|argument| {
                    matches!(argument, v04::ast::CallArgument::Binder(value) if self.contains_return(&value.body))
                }) {
                    self.unsupported(
                        expression.span,
        ...
        if let Some((index, value)) =
            arguments
                ...
                .find_map(|(index, argument)| match argument {
                    v04::ast::CallArgument::Expression(value) if self.contains_return(value) => {
        ...
        match continuation {
            ...
            PureContinuation::Unary {
                ...
                let value = ast::Spanned::new(
                    ast::ExprKind::Unary {
                        op: ast::Spanned::new(
                            match operator {
                                v04::ast::UnaryOperator::Not => ast::UnaryOp::Not,
                                v04::ast::UnaryOperator::Negate => ast::UnaryOp::Negate,
                            },
                            source_span,
                        ),
            ...
            PureContinuation::ShortCircuitLeft {
                ...
                let short_value = ast::Spanned::new(
                    ast::ExprKind::Bool(matches!(operator, v04::ast::BinaryOperator::Or)),
                    self.span(span),
                );
            ...
            PureContinuation::BinaryRight {
                ...
                let value = ast::Spanned::new(
                    ast::ExprKind::Binary {
                        ...
                        op: ast::Spanned::new(
                            match operator {
                                v04::ast::BinaryOperator::Multiply => ast::BinaryOp::Multiply,
                                v04::ast::BinaryOperator::Add => ast::BinaryOp::Add,
                                v04::ast::BinaryOperator::Subtract => ast::BinaryOp::Subtract,
                                v04::ast::BinaryOperator::And => ast::BinaryOp::And,
                                v04::ast::BinaryOperator::Or => ast::BinaryOp::Or,
                            },
                            source_span,
                        ),
                        right: Box::new(value),
            ...
            PureContinuation::CompareRight {
                ...
                let value = ast::Spanned::new(
                    ast::ExprKind::Binary {
                        ...
                        op: ast::Spanned::new(
                            match operator {
                                v04::ast::ComparisonOperator::Equal => ast::BinaryOp::Equal,
                                v04::ast::ComparisonOperator::NotEqual => ast::BinaryOp::NotEqual,
                                v04::ast::ComparisonOperator::Less => ast::BinaryOp::Less,
                                v04::ast::ComparisonOperator::LessEqual => ast::BinaryOp::LessEqual,
                                v04::ast::ComparisonOperator::Greater => ast::BinaryOp::Greater,
                                v04::ast::ComparisonOperator::GreaterEqual => {
            ...
            PureContinuation::CallArgument {
                ...
                env.values.insert(temporary.clone(), value);
                arguments[index] =
                    v04::ast::CallArgument::Expression(source_name_expression(temporary, span));
        ...
        block
            ...
            .map(|statement| {
                let value = match &statement.kind {
                    ...
                    v04::ast::StatementKind::Unreachable { .. } => ast::StatementKind::Expr(
                        ast::Spanned::new(ast::ExprKind::Unreachable, self.span(statement.span)),
                    ),
                    v04::ast::StatementKind::Expression { expression, .. }
    ...
    fn effect_expr(
        ...
        match &expression.kind {
            v04::ast::ExpressionKind::Return(value) => ast::Spanned::new(
            ...
            v04::ast::ExpressionKind::If(value) => {
                ...
                let else_branch = value.else_branch.as_ref().map(|branch| {
                    Box::new(match branch {
                        v04::ast::ElseBranch::Block(block) => ast::Spanned::new(
                            ast::ExprKind::Block(self.reaction_block(block, env, terminal)),
                            self.span(block.span),
                        ),
                        v04::ast::ElseBranch::If(value) => self.effect_expr(value, env, terminal),
                    })
                });
                ast::Spanned::new(
                    ast::ExprKind::If {
            ...
            v04::ast::ExpressionKind::Match(value) => ast::Spanned::new(
                ast::ExprKind::Match {
            ...
            v04::ast::ExpressionKind::Block(block) => ast::Spanned::new(
                ast::ExprKind::Block(self.reaction_block(block, env, terminal)),
                span,
            ),
    ...
    fn initializer_expr(&mut self, expression: &v04::ast::Expression) -> ast::Expr {
    ...
    fn expr(&mut self, expression: &v04::ast::Expression, env: &ExprEnv) -> ast::Expr {
        let span = self.span(expression.span);
        let value = match &expression.kind {
            v04::ast::ExpressionKind::Literal(value) => match value {
                v04::ast::Literal::Bool(value) => ast::ExprKind::Bool(*value),
                v04::ast::Literal::Integer { raw } => ast::ExprKind::Integer(raw.clone()),
                v04::ast::Literal::Decimal { raw } => ast::ExprKind::Decimal(raw.clone()),
                v04::ast::Literal::Text { value, .. } => ast::ExprKind::Text(value.clone()),
            },
            v04::ast::ExpressionKind::Unit => ast::ExprKind::Tuple(Vec::new()),
            v04::ast::ExpressionKind::Sequence(values) => {
            ...
            v04::ast::ExpressionKind::Group(value) => return self.expr(value, env),
            v04::ast::ExpressionKind::Name(value) => {
            ...
            v04::ast::ExpressionKind::Member { value, member } => ast::ExprKind::Member {
                receiver: Box::new(self.expr(value, env)),
                member: self.name(member),
            },
            v04::ast::ExpressionKind::Index { value, index } => ast::ExprKind::Index {
                receiver: Box::new(self.expr(value, env)),
                index: Box::new(self.expr(index, env)),
            },
            v04::ast::ExpressionKind::Unary { operator, value } => ast::ExprKind::Unary {
                op: ast::Spanned::new(
                    match operator {
                        v04::ast::UnaryOperator::Not => ast::UnaryOp::Not,
                        v04::ast::UnaryOperator::Negate => ast::UnaryOp::Negate,
            ...
            v04::ast::ExpressionKind::Compare {
                ...
                op: ast::Spanned::new(
                    match operator {
                        ...
                        v04::ast::ComparisonOperator::LessEqual => ast::BinaryOp::LessEqual,
                        v04::ast::ComparisonOperator::Greater => ast::BinaryOp::Greater,
                        v04::ast::ComparisonOperator::GreaterEqual => ast::BinaryOp::GreaterEqual,
                    },
                    span,
                ),
                right: Box::new(self.expr(right, env)),
            },
            v04::ast::ExpressionKind::Is { value, pattern } => ast::ExprKind::Is {
                value: Box::new(self.expr(value, env)),
                pattern: self.pattern(pattern),
            },
            v04::ast::ExpressionKind::If(value) => ast::ExprKind::If {
                condition: Box::new(self.expr(&value.condition, env)),
                ...
                else_branch: value.else_branch.as_ref().map(|branch| {
                    Box::new(match branch {
                        ...
                        v04::ast::ElseBranch::If(value) => self.expr(value, env),
                    })
                }),
            },
            v04::ast::ExpressionKind::Match(value) => ast::ExprKind::Match {
                subject: Box::new(self.expr(&value.value, env)),
                arms: value
                    .arms
                    .iter()
    ...
    fn inline_private_function(
        ...
        function: &v04::ast::FunctionDeclaration,
        arguments: &[v04::ast::CallArgument],
        env: &ExprEnv,
    ) -> ast::Expr {
        ...
        if arguments.len() != function.parameters.len()
            || arguments
                .iter()
                .any(|argument| matches!(argument, v04::ast::CallArgument::Binder(_)))
        {
            self.diagnostics.push(error(
                codes::ARITY,
        ...
        for (parameter, argument) in function.parameters.iter().zip(arguments) {
            let v04::ast::CallArgument::Expression(argument) = argument else {
    ...
    fn call_expression(
        ...
        if let v04::ast::ExpressionKind::Member { value, member } = &callee.kind {
            if arguments.is_empty()
                && matches!(
                    member.text.as_str(),
                    "values"
            ...
            if member.text == "try_map_values"
                && arguments.len() == 1
                && let v04::ast::CallArgument::Binder(binder) = &arguments[0]
            {
    ...
    fn callee_expression(&mut self, callee: &v04::ast::Expression, env: &ExprEnv) -> ast::Expr {
        if let v04::ast::ExpressionKind::Name(name) = &callee.kind
            && name.segments.len() == 2
    ...
    fn call_arguments(
        ...
        arguments
            ...
            .map(|argument| match argument {
                v04::ast::CallArgument::Expression(value) => self.expr(value, env),
    ...
    fn entry_binder(
        &mut self,
        binder: &v04::ast::BinderExpression,
        env: &ExprEnv,
    ...
    fn table_from(
        ...
        let Some(v04::ast::CallArgument::Expression(argument)) = arguments.first() else {
            self.unsupported(
                span,
        ...
        let v04::ast::ExpressionKind::Sequence(values) = &argument.kind else {
            self.unsupported(
                argument.span,
        ...
        for pair in values {
            let v04::ast::ExpressionKind::Tuple(items) = &pair.kind else {
                self.unsupported(
                    pair.span,
            ...
            entries.push(ast::RecordEntry {
                key: if let v04::ast::ExpressionKind::Name(name) = &items[0].kind
                    && self.is_variant_name(name)
                {
                    ast::Spanned::new(
    ...
    fn routes_from(
        ...
        let entries = values
            ...
            .filter_map(|pair| {
                ...
                let v04::ast::ExpressionKind::Literal(v04::ast::Literal::Text {
                    value: constructor,
                    ..
                }) = &items[0].kind
                else {
    ...
    fn routes_call(&mut self, span: v04::ast::Span, entries: Vec<ast::RecordEntry>) -> ast::Expr {
        let source_span = self.span(span);
        ast::Spanned::new(
            ast::ExprKind::Call {
                callee: Box::new(ast::Spanned::new(
    ...
    fn set_filter_map(
        ...
        let (
            Some(v04::ast::CallArgument::Expression(source)),
            Some(v04::ast::CallArgument::Binder(binder)),
    ...
    fn empty_set_comprehension(&mut self, span: v04::ast::Span) -> ast::Expr {
    ...
    fn record_expression(
        &mut self,
        span: v04::ast::Span,
        value: &v04::ast::RecordExpression,
        env: &ExprEnv,
    ) -> ast::Expr {
    ...
    fn ordered_fields(
        ...
        span: v04::ast::Span,
        shape: &RecordShape,
        fields: &[v04::ast::FieldInitializer],
        env: &ExprEnv,
    ) -> Vec<ast::Expr> {
    ...
    fn record_entry(
        &mut self,
        field: &v04::ast::FieldInitializer,
        env: &ExprEnv,
    ) -> ast::RecordEntry {
        ast::RecordEntry {
            key: ast::Spanned::new(
    ...
    fn pattern(&mut self, pattern: &v04::ast::Pattern) -> ast::Pattern {
        let span = self.span(pattern.span);
        let value = match &pattern.kind {
            v04::ast::PatternKind::Wildcard => ast::PatternKind::Wildcard,
            v04::ast::PatternKind::Binder(value) => ast::PatternKind::Name(self.name(value)),
            v04::ast::PatternKind::Literal(value) => match value {
                v04::ast::PatternLiteral::Bool(value) => ast::PatternKind::Bool(*value),
                v04::ast::PatternLiteral::Integer { raw, negative } => {
                ...
                v04::ast::PatternLiteral::Decimal { raw, negative } => {
                ...
                v04::ast::PatternLiteral::Text { value, .. } => {
                    ast::PatternKind::Text(value.clone())
                }
                v04::ast::PatternLiteral::Unit => ast::PatternKind::Tuple(Vec::new()),
            },
            v04::ast::PatternKind::Group(value) => return self.pattern(value),
            v04::ast::PatternKind::Tuple(values) => {
                ast::PatternKind::Tuple(values.iter().map(|value| self.pattern(value)).collect())
            }
            v04::ast::PatternKind::Constructor(value) => {
                if value.segments.len() == 1 {
    ...
    fn qualified_value_name(&self, value: &v04::ast::QualifiedName) -> ast::Name {
    ...
    fn qualified_pattern_name(&self, value: &v04::ast::QualifiedName) -> ast::Name {
        self.qualified_value_name(value)
    }

    fn qualified_callee(&self, value: &v04::ast::Expression) -> Option<Vec<String>> {
        let v04::ast::ExpressionKind::Name(value) = &value.kind else {
            return None;
        };
        Some(
            value
    ...
    fn is_variant_name(&self, value: &v04::ast::QualifiedName) -> bool {
    ...
    fn is_entries_call(&self, value: &v04::ast::Expression) -> bool {
        match &value.kind {
            v04::ast::ExpressionKind::Call { callee, arguments } if arguments.is_empty() => {
                matches!(
                    &callee.kind,
                    v04::ast::ExpressionKind::Member { member, .. } if member.text == "entries"
                )
            }
            _ => false,
        }
    ...
    fn is_named_call(&self, value: &v04::ast::Expression) -> bool {
        matches!(
            &value.kind,
    ...
    fn type_field(&mut self, value: &v04::ast::TypedField) -> ast::TypeField {
        ast::TypeField {
            name: self.name(&value.name),
            ty: self.ty(&value.ty),
            span: self.span(value.span),
    ...
    fn parameter(&mut self, value: &v04::ast::Parameter) -> ast::Parameter {
        ast::Parameter {
            name: self.name(&value.name),
            ty: self.ty(&value.ty),
            span: self.span(value.span),
    ...
    fn ty(&mut self, value: &v04::ast::TypeExpression) -> ast::TypeExpr {
        let span = self.span(value.span);
        let kind = match &value.kind {
            v04::ast::TypeExpressionKind::Path(path) => {
            ...
            v04::ast::TypeExpressionKind::Unit => ast::TypeExprKind::Tuple(Vec::new()),
    ...
    fn contains_return(&self, expression: &v04::ast::Expression) -> bool {
        match &expression.kind {
            ...
            v04::ast::ExpressionKind::Group(value)
            | v04::ast::ExpressionKind::Unary { value, .. } => self.contains_return(value),
            v04::ast::ExpressionKind::Record(value) => {
                value
                    .fields
                    .iter()
            ...
            v04::ast::ExpressionKind::Call { callee, arguments } => {
                self.contains_return(callee)
                    || arguments.iter().any(|argument| match argument {
                        v04::ast::CallArgument::Expression(value) => self.contains_return(value),
                        v04::ast::CallArgument::Binder(value) => self.contains_return(&value.body),
                    })
            }
            v04::ast::ExpressionKind::Member { value, .. } => self.contains_return(value),
            ...
            v04::ast::ExpressionKind::Is { value, .. } => self.contains_return(value),
            v04::ast::ExpressionKind::If(value) => {
                self.contains_return(&value.condition)
                    ...
                    || value
                        ...
                        .is_some_and(|branch| match branch {
                            ...
                            v04::ast::ElseBranch::If(value) => self.contains_return(value),
                        })
            }
    ...
    fn block_contains_return(&self, block: &v04::ast::Block) -> bool {
        block
            .statements
            .iter()
            .any(|statement| self.statement_contains_return(statement))
    ...
    fn statement_contains_return(&self, statement: &v04::ast::Statement) -> bool {
        match &statement.kind {
            v04::ast::StatementKind::Let { value, .. }
            | v04::ast::StatementKind::Assign { value, .. } => self.contains_return(value),
    ...
    fn name(&self, value: &v04::ast::Identifier) -> ast::Name {
    ...
    fn resolved_name(&self, value: &v04::ast::Identifier) -> ast::Name {
        ast::Spanned::new(
    ...
    fn resolved_path(&self, values: &[v04::ast::Identifier]) -> Vec<ast::Name> {
        values
            .iter()
            .enumerate()
            .map(|(index, value)| {
    ...
    fn span(&self, value: v04::ast::Span) -> ast::SourceSpan {
        ast::SourceSpan::new(value.file, value.start, value.end)
    }

    fn unsupported(&mut self, span: v04::ast::Span, message: impl Into<String>) {
        self.diagnostics.push(error(
            codes::UNSUPPORTED,
