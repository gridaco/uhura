...
its primary form and may refer to a shared, version-scoped integration
contract.

Integration contracts must make availability, capabilities, effects, privacy
and security boundaries, fallback behavior, and offline or deterministic
preview representation explicit.
