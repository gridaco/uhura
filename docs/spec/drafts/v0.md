# Uhura v0 incubation language model

- **Status:** Disposable pre-specification draft
- **Target:** v0 incubation; no compatibility promise
- **Lifetime:** May be rewritten, split, or deleted as a unit
- **Design doctrine:** [Uhura doctrine](../../doctrine/README.md)
- **Foundation proposal:** [Draft RFC 0001](../../rfcs/0001-project-foundation.md)
- **Accepted source-language RFC:**
  [RFC 0003](../../rfcs/0003-source-comments-docs-and-annotations.md)
- **Prior art:** XAML, Svelte, QML, Elm

This draft explores one exact v0 shape for **Uhura**, a declarative UI
language, checker/compiler, and deterministic headless experience runtime. It
is not an unversioned master specification, and later language generations do
not inherit its topology by default. Its current source suffix is `.uhura`.
The complete grammar and serialization are not yet accepted; the comment,
declaration-doc, and markup-annotation subsystem in §13 is accepted
independently.
...
> accepted by an RFC and backed by executable tests. Replacing or deleting
> this v0 draft does not require preserving its sections, names, or machine
> shape.
...
The [application-scale stress-test requirements](../../studies/application-scale-stress-test.md)
