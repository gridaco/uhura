...
### 4.6 Spike source — `components/post-card.uhura`
...
### 4.7 Spike source — `app/feed/page.uhura`
...
- **Reentrancy (spike invariant):** renderer emissions always **enqueue**; a
  ...
  re-entry panic).
- **textfield (spike invariant):** core owns the draft; renderer owns caret/IME.
...
[`<icon>`](../widgets/drafts/v0/elements/icon.md) and the
[icon-font integration](../widgets/drafts/v0/integrations/icon-font.md).
