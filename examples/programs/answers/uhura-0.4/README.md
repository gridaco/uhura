...
against which the 0.4 grammar, formatter, checker, lowering, and differential
runtime behavior are tested. It answers:
...
replays this file. Differential tests compare its committed state,
observations, outcomes, commands, faults, and replay behavior with the retained
0.3 answer. It remains subordinate to the language-neutral problems.
