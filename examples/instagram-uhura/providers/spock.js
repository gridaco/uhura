...
/**
 * @typedef {Object} SpockDriverConfig
 * @property {string} graphql_url Full Spock `/graphql/v1` endpoint.
 * @property {string} rpc_url Spock `/rest/v1/rpc` prefix.
 * @property {string} storage_url Spock `/storage/v1` prefix.
 * @property {string} actor Seeded user UUID or unique username.
 */

/**
 * @typedef {Object} SpockDriver
 * @property {() => Promise<string>} assembleBoot
 * @property {(commandJson: string) => void} deliver
 * @property {() => string[]} tick
 * @property {() => boolean} idle
 * @property {(asset: string) => Promise<string>} resolveAsset
 * @property {() => import("../../../shell/types.js").RemoteSystemInfo} systemInfo
 */
 ...
 * @typedef {Promise<{ file: File | null } | { error: unknown }>} PickedFile
 */

/** @typedef {{ id: string }} GraphRef */
 ...
 * @property {GraphRef} avatar
 * @property {string} avatar_alt
 * @property {string | null} bio
 */

/**
 * @typedef {Object} GraphStory
 * @property {string} id
 * @property {GraphRef} author
 * @property {number} position
 * @property {GraphRef} media_file
...
/**
 * @typedef {Object} GraphStoryView
 * @property {GraphRef} viewer
 * @property {GraphRef} story
 * @property {string} at
 */

/**
 * @typedef {Object} GraphPost
 * @property {string} id
 * @property {GraphRef} author
...
/**
 * @typedef {Object} GraphSlide
 * @property {string} id
 * @property {GraphRef} post
 * @property {number} position
 * @property {GraphRef} file
 * @property {string} alt
 */
...
/**
 * @typedef {Object} GraphPostTag
 * @property {GraphRef} post
 * @property {GraphRef} person
 */

/**
 * @typedef {Object} SnapshotData
 * @property {UserRow[]} users
 * @property {GraphStory[]} stories
 * @property {GraphStoryView[]} storyViews
 * @property {GraphPost[]} posts
...
/**
 * @typedef {Object} GraphQlEnvelope
 * @property {SnapshotData} [data]
 * @property {GraphQlError[]} [errors]
 */
...
/**
 * @typedef {{ ok: true, result: unknown } | { ok: false, error: SpockError }} RpcReply
 */
...
/**
 * @typedef {Object} ProjectionUpdate
 * @property {string} port
...
/**
 * @typedef {{ ok: Record<string, never> }
 *   | { refused: { refusal: string } }
 *   | { unavailable: { reason: string } }} CommandOutcome
 */
...
export function createDriver(
  { graphql_url, rpc_url, storage_url, actor },
  host,
) {
  ...
  /** @type {Map<string, { url: string, refreshAt: number }>} */
  ...
  const db = {
    /** @type {Map<string, UserRow>} */ users: new Map(),
    /** @type {StoryRow[]} */ stories: [],
    /** @type {Set<string>} */ storyViews: new Set(),
    /** @type {PostRow[]} */ posts: [],
    /** @type {Map<string, SlideRow[]>} */ slidesByPost: new Map(),
    ...
    /** @type {Map<string, string[]>} */ taggedPostsByUser: new Map(),
  };
