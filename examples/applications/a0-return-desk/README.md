...
## Answer sheets and oracle

- [Uhura 0.3 answer sheet](answers/uhura-0.3/) — executable machine,
  checked web projection, evidence source, and host manifest.
- [Uhura 0.4 answer sheet](answers/uhura-0.4/) — the same application and
